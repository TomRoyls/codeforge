...
describe('Treap (treap-5)', () => {
  ...
  describe('constructor', () => {
    ...
    it('should accept a custom comparator', () => {
      ...
      const t = new Treap<number>(reverseCmp)
      t.insert(1)
      t.insert(2)
      t.insert(3)
  ...
  describe('inOrderTraversal', () => {
    ...
    it('should return sorted elements', () => {
      ...
      treap.insert(10)
      treap.insert(20)
      expect(treap.inOrderTraversal()).toEqual([10, 20, 30])
    })
  })

  describe('toArray', () => {
    it('should return the same as inOrderTraversal', () => {
      treap.insert(3)
      treap.insert(1)
      treap.insert(2)
      expect(treap.toArray()).toEqual(treap.inOrderTraversal())
    })
