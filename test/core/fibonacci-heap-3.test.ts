...
import { FibonacciHeap3 } from '../../src/core/fibonacci-heap-3/index.js'
import type { FibonacciHeap3Node } from '../../src/core/fibonacci-heap-3/types.js'

describe('FibonacciHeap3', () => {
  describe('constructor', () => {
    it('creates an empty heap with default comparator', () => {
      const heap = new FibonacciHeap3()
      expect(heap.size).toBe(0)
      expect(heap.isEmpty).toBe(true)
    })

    it('creates a heap with custom comparator', () => {
      const heap = new FibonacciHeap3<string>({
  ...
  describe('insert', () => {
    ...
    it('insert returns node with mark false', () => {
      const heap = new FibonacciHeap3<number>()
      const node = heap.insert(10)
      expect(node.mark).toBe(false)
    })

    it('insert returns node that is self-referencing', () => {
      const heap = new FibonacciHeap3<number>()
      const node = heap.insert(10)
  ...
  describe('decreaseKey', () => {
    ...
    it('throws on empty heap', () => {
      const heap = new FibonacciHeap3<number>()
      const node: FibonacciHeap3Node<number> = {
        value: 5,
        degree: 0,
        parent: null,
        child: null,
    ...
    it('triggers cut and cascading cut', () => {
      const heap = new FibonacciHeap3<number>()
      const nodes: FibonacciHeap3Node<number>[] = []
      for (let i = 10; i >= 1; i--) {
    ...
    it('decreaseKey triggers cut from parent when smaller', () => {
      const heap = new FibonacciHeap3<number>()
      const nodes: FibonacciHeap3Node<number>[] = []
      for (let i = 1; i <= 8; i++) {
  ...
  describe('update', () => {
    ...
    it('update with max-heap comparator', () => {
      const heap = new FibonacciHeap3<number>({ comparator: (a, b) => b - a })
      const node = heap.insert(5)
      heap.insert(10)
      const result = heap.update(node, 20)
      expect(result.value).toBe(20)
  ...
  describe('static merge', () => {
    it('creates a new merged heap without modifying originals', () => {
      ...
      heap1.insert(5)
      heap2.insert(3)
      const merged = FibonacciHeap3.merge(heap1, heap2)
  ...
  describe('fromArray', () => {
    it('creates heap from array', () => {
      const heap = FibonacciHeap3.fromArray([3, 1, 2])
      expect(heap.size).toBe(3)
      expect(heap.toSortedArray()).toEqual([1, 2, 3])
    })

    it('creates heap from empty array', () => {
      const heap = FibonacciHeap3.fromArray([])
      expect(heap.isEmpty).toBe(true)
    })

    it('creates heap with custom comparator', () => {
      const heap = FibonacciHeap3.fromArray([1, 2, 3], {
        comparator: (a, b) => b - a,
      })
    ...
    it('creates heap from single element array', () => {
      const heap = FibonacciHeap3.fromArray([42])
      expect(heap.size).toBe(1)
      expect(heap.peek()).toBe(42)
    })
  })
  ...
  describe('generics', () => {
    ...
    it('works with objects via custom comparator', () => {
      ...
      const heap = new FibonacciHeap3<Item>({
    ...
    it('works with dates', () => {
      const heap = new FibonacciHeap3<Date>({
    ...
    it('works with custom type and decreaseKey', () => {
      ...
      const heap = new FibonacciHeap3<Task>({
        comparator: (a, b) => a.priority - b.priority,
      })
  ...
  describe('type exports', () => {
    it('exports FibonacciHeap3Node type', () => {
      const heap = new FibonacciHeap3<number>()
      const node: FibonacciHeap3Node<number> = heap.insert(5)
      expect(node.value).toBe(5)
      expect(node.degree).toBe(0)
      expect(node.parent).toBeNull()
      expect(node.mark).toBe(false)
    ...
    it('exports FibonacciHeap3Options type', () => {
      const heap = new FibonacciHeap3<number>({
        comparator: (a, b) => a - b,
      })
  ...
  describe('complex scenarios', () => {
    it('Dijkstra-like usage pattern', () => {
      const heap = new FibonacciHeap3<{ node: number; dist: number }>({
    ...
    it('multiple merges and operations', () => {
      const h1 = new FibonacciHeap3<number>()
      const h2 = new FibonacciHeap3<number>()
      const h3 = new FibonacciHeap3<number>()
      h1.insert(10)
      h2.insert(5)
      h3.insert(3)
      h1.merge(h2)
    ...
    it('fromArray then mixed operations', () => {
      const heap = FibonacciHeap3.fromArray([5, 3, 8, 1, 9, 2])
      expect(heap.extractMin()).toBe(1)
      heap.insert(0)
      expect(heap.peek()).toBe(0)
      const sorted = heap.toSortedArray()
    ...
    it('contains with custom comparator objects', () => {
      ...
      const heap = new FibonacciHeap3<Point>({
  ...
  describe('static fromArray with operations', () => {
    it('fromArray then merge', () => {
      const a = FibonacciHeap3.fromArray([1, 3, 5])
      const b = FibonacciHeap3.fromArray([2, 4, 6])
      const merged = FibonacciHeap3.merge(a, b)
