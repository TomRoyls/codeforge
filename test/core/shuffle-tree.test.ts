...
describe('ShuffleTree', () => {
  describe('constructor', () => {
    ...
    it('creates tree with numeric comparator', () => {
      const tree = new ShuffleTree<number>({ comparator: (a, b) => a - b })
      tree.insert(5)
  ...
  describe('edge cases', () => {
    ...
    it('handles sorted input without degradation', () => {
      const tree = new ShuffleTree<number>()
      for (let i = 0; i < 50; i++) {
        tree.insert(i)
      }
      expect(tree.size()).toBe(50)
      expect(tree.height()).toBeLessThan(50)
      const arr = tree.toArray()
      for (let i = 0; i < 50; i++) {
        expect(arr[i]).toBe(i)
      }
    ...
    it('handles reverse sorted input without degradation', () => {
      const tree = new ShuffleTree<number>()
      for (let i = 49; i >= 0; i--) {
        tree.insert(i)
      }
    ...
    it('handles inserting same value repeatedly', () => {
      const tree = new ShuffleTree<number>()
      for (let i = 0; i < 100; i++) {
        tree.insert(42)
      }
  ...
  describe('custom comparator', () => {
    ...
    it('works with object comparator', () => {
      ...
      const tree = new ShuffleTree<Item>({
  ...
  describe('duplicate handling', () => {
    it('does not insert exact duplicates', () => {
      const tree = new ShuffleTree<number>()
      tree.insert(5)
      tree.insert(5)
      expect(tree.size()).toBe(1)
    ...
    it('does not insert string duplicates', () => {
      const tree = new ShuffleTree<string>()
      tree.insert('hello')
      tree.insert('hello')
      expect(tree.size()).toBe(1)
  ...
  describe('type variants', () => {
    ...
    it('works with dates using comparator', () => {
      const tree = new ShuffleTree<Date>({
    ...
    it('works with booleans', () => {
      const tree = new ShuffleTree<boolean>()
      tree.insert(false)
      tree.insert(true)
