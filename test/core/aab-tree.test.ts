...
import { AABTree } from '../../src/core/aab-tree/index.js'
...
describe('AABTree', () => {
  ...
  describe('constructor', () => {
    it('should create an empty tree', () => {
      const t = new AABTree<number>()
      expect(t.size()).toBe(0)
      expect(t.isEmpty()).toBe(true)
    })

    it('should accept a custom comparator', () => {
      const t = new AABTree<string>((a, b) => a.localeCompare(b))
      t.insert('cherry')
      t.insert('apple')
      t.insert('banana')
  ...
  describe('insert', () => {
    ...
    it('should allow duplicate inserts (goes right)', () => {
      tree.insert(5)
      tree.insert(5)
      expect(tree.size()).toBe(2)
      expect(tree.inOrderTraversal()).toEqual([5, 5])
    })
  ...
  describe('search / contains', () => {
    ...
    it('should return false on empty tree', () => {
      const empty = new AABTree<number>()
