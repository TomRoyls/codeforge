...
import { LeftistHeap } from '../../src/core/leftist-heap/leftist-heap.js'

function createMinHeap(): LeftistHeap<number> {
  return new LeftistHeap<number>()
}

function createMaxHeap(): LeftistHeap<number> {
  return new LeftistHeap<number>({
    comparator: (a, b) => b - a,
  })
}
...
describe('LeftistHeap', () => {
  ...
  describe('extractMin', () => {
    ...
    it('maintains valid leftist property after extractions', () => {
      const heap = createMinHeap()
      for (let i = 1; i <= 10; i++) {
        heap.insert(i)
      }
  ...
  describe('edge cases', () => {
    ...
    it('works with objects using custom comparator', () => {
      ...
      const heap = new LeftistHeap<Point>({
  ...
  describe('type safety', () => {
    ...
    it('works with custom type', () => {
      ...
      const heap = new LeftistHeap<PriorityItem>({
