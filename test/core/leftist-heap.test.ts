...
import type { Comparator } from '../../src/core/leftist-heap/types.js'
...
describe('LeftistHeap', () => {
  ...
  describe('decreaseKey', () => {
    ...
    it('throws when newValue > oldValue', () => {
      const heap = new LeftistHeap([3, 1, 2])
      expect(() => heap.decreaseKey(1, 5)).toThrow('newValue must be less than or equal to oldValue')
    })

    it('throws when value not found', () => {
      const heap = new LeftistHeap([3, 1, 2])
      expect(() => heap.decreaseKey(10, 0)).toThrow('value not found in heap')
    })

    it('maintains heap property after decrease', () => {
      const heap = new LeftistHeap([5, 3, 7, 1, 4])
  ...
  describe('delete', () => {
    ...
    it('deletes duplicate element (one copy)', () => {
      const heap = new LeftistHeap([2, 1, 2, 1, 2])
      heap.delete(2)
      expect(heap.size).toBe(4)
    })
