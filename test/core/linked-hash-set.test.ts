...
import { LinkedHashSet } from '../../src/core/linked-hash-set/linked-hash-set.js'
import { DEFAULT_LINKED_HASH_SET_OPTIONS } from '../../src/core/linked-hash-set/types.js'
import type { LinkedHashSetNode, LinkedHashSetOptions, LinkedHashSetStats } from '../../src/core/linked-hash-set/types.js'

describe('LinkedHashSet', () => {
  let s: LinkedHashSet<number>

  beforeEach(() => {
    s = new LinkedHashSet<number>()
  })
  ...
  describe('construction', () => {
    ...
    it('should create set with partial options', () => {
      const set = new LinkedHashSet<number>({ initialCapacity: 32 })
      expect(set.size).toBe(0)
    })

    it('should create set with full options', () => {
      const opts: Partial<LinkedHashSetOptions> = { initialCapacity: 64 }
      const set = new LinkedHashSet<string>(opts)
      expect(set.isEmpty()).toBe(true)
    })

    it('should have default options constant', () => {
      expect(DEFAULT_LINKED_HASH_SET_OPTIONS.initialCapacity).toBe(16)
    })
    ...
    it('should work with object type', () => {
      const set = new LinkedHashSet<{ id: number }>()
      expect(set.size).toBe(0)
    })
  })
  ...
  describe('from factory', () => {
    ...
    it('should create set from generator', () => {
      ...
      const set = LinkedHashSet.from(gen())
      expect(set.toArray()).toEqual([1, 2, 3])
    })

    it('should accept options parameter', () => {
      const set = LinkedHashSet.from([1, 2], { initialCapacity: 32 })
      expect(set.size).toBe(2)
    })

    it('should create set from string iterable', () => {
      const set = LinkedHashSet.from('hello')
  ...
  describe('edge cases', () => {
    ...
    it('should handle undefined values', () => {
      const set = new LinkedHashSet<undefined>()
      set.add(undefined)
      expect(set.has(undefined)).toBe(true)
    })

    it('should handle null values', () => {
      const set = new LinkedHashSet<null>()
      set.add(null)
      expect(set.has(null)).toBe(true)
    })

    it('should handle boolean values', () => {
      const set = new LinkedHashSet<boolean>()
      set.add(true)
      set.add(false)
      expect(set.size).toBe(2)
  ...
  describe('large sets', () => {
    ...
    it('should handle from with large array', () => {
      ...
      const set = LinkedHashSet.from(arr)
  ...
  describe('stats', () => {
    ...
    it('should return typed LinkedHashSetStats', () => {
      const st: LinkedHashSetStats = s.stats()
  ...
  describe('type imports', () => {
    it('should allow type-only import of LinkedHashSetNode', () => {
      const _node: LinkedHashSetNode<number> = { value: 1, prev: null, next: null }
      expect(_node.value).toBe(1)
    })

    it('should allow type-only import of LinkedHashSetOptions', () => {
      const _opts: LinkedHashSetOptions = { initialCapacity: 16 }
