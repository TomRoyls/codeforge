...
describe('HashTable3', () => {
  ...
  describe('set / get', () => {
    ...
    it('handles numeric keys', () => {
      const ht = new HashTable3<number, string>();
      ht.set(1, 'one');
      ht.set(2, 'two');
  ...
  describe('edge cases', () => {
    ...
    it('handles object keys via toString', () => {
      const ht = new HashTable3<object, number>();
