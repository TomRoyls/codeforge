...
describe('KDTree4', () => {
  describe('constructor', () => {
    ...
    it('should handle single dimension', () => {
      const points = [[1], [3], [5]];
      const tree = new KDTree4(points, 1);
      expect(tree.size).toBe(3);
    ...
    it('should handle 3 dimensions', () => {
      ...
      const tree = new KDTree4(points, 3);
      expect(tree.size).toBe(3);
  ...
  describe('delete', () => {
    it('should delete existing point', () => {
      const tree = new KDTree4([[1, 2], [3, 4]]);
      const result = tree.delete([1, 2]);
    ...
    it('should return false for non-existent point', () => {
      const tree = new KDTree4([[1, 2]]);
      const result = tree.delete([3, 4]);
    ...
    it('should delete duplicate points', () => {
      const tree = new KDTree4();
      tree.insert([1, 2]);
      tree.insert([1, 2]);
      tree.delete([1, 2]);
  ...
  describe('search', () => {
    ...
    it('should find exact match only', () => {
      const tree = new KDTree4([[1, 2]]);
      expect(tree.search([1.1, 2])).toBe(null);
      expect(tree.search([1, 2.1])).toBe(null);
    });
  });
  ...
  describe('kNearestNeighbors', () => {
    ...
    it('should return exactly k neighbors when available', () => {
      const tree = new KDTree4([[1, 2], [3, 4], [5, 6]]);
    ...
    it('should return k neighbors in order of distance', () => {
      const tree = new KDTree4([[1, 1], [2, 2], [3, 3], [4, 4]]);
      const result = tree.kNearestNeighbors([0, 0], 3);
  ...
  describe('rangeSearch', () => {
    ...
    it('should include points on range boundaries', () => {
      const tree = new KDTree4([[1, 1], [5, 5]]);
      const result = tree.rangeSearch([1, 1], [5, 5]);
      expect(result).toHaveLength(2);
    });

    it('should work with negative coordinates', () => {
      const tree = new KDTree4([[-5, -5], [0, 0], [5, 5]]);
    ...
    it('should work with 3 dimensions', () => {
      const tree = new KDTree4([[1, 2, 3], [4, 5, 6]], 3);
  ...
  describe('min', () => {
    it('should return null for empty tree', () => {
      const tree = new KDTree4();
      expect(tree.min(0)).toBe(null);
      expect(tree.min(1)).toBe(null);
    });

    it('should find min for axis 0', () => {
      const tree = new KDTree4([[5, 10], [1, 2], [10, 5]]);
      const result = tree.min(0);
      expect(result).toEqual([1, 2]);
    });

    it('should find min for axis 1', () => {
      const tree = new KDTree4([[5, 10], [1, 2], [10, 5]]);
    ...
    it('should work with 3 dimensions', () => {
      const tree = new KDTree4([[5, 10, 15], [1, 2, 3], [10, 5, 1]], 3);
  ...
  describe('max', () => {
    it('should return null for empty tree', () => {
      const tree = new KDTree4();
      expect(tree.max(0)).toBe(null);
      expect(tree.max(1)).toBe(null);
    });

    it('should find max for axis 0', () => {
      const tree = new KDTree4([[5, 10], [1, 2], [10, 5]]);
      const result = tree.max(0);
      expect(result).toEqual([10, 5]);
    });

    it('should find max for axis 1', () => {
      const tree = new KDTree4([[5, 10], [1, 2], [10, 5]]);
  ...
  describe('axis-aligned splits', () => {
    it('should split on x-axis first then y-axis', () => {
      const tree = new KDTree4([[1, 10], [10, 1]]);
  ...
  describe('single point operations', () => {
    ...
    it('should insert then delete single point', () => {
      const tree = new KDTree4();
      tree.insert([1, 1]);
      expect(tree.size).toBe(1);
      expect(tree.delete([1, 1])).toBe(true);
      expect(tree.isEmpty).toBe(true);
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle points with same coordinate', () => {
      const tree = new KDTree4([[1, 1], [1, 2], [1, 3]]);
      expect(tree.size).toBe(3);
    ...
    it('should handle zero coordinates', () => {
      const tree = new KDTree4([[0, 0]]);
      expect(tree.contains([0, 0])).toBe(true);
      expect(tree.nearestNeighbor([1, 1])).toEqual([0, 0]);
    });

    it('should handle very large coordinates', () => {
      const tree = new KDTree4([[1000000, 1000000]]);
      expect(tree.contains([1000000, 1000000])).toBe(true);
    });

    it('should handle deleting root with children', () => {
      const tree = new KDTree4([[2, 2], [1, 1], [3, 3]]);
      tree.delete([2, 2]);
      expect(tree.size).toBe(2);
  ...
  describe('kNearestNeighbors edge cases', () => {
    it('should handle k=1 correctly', () => {
      const tree = new KDTree4([[1, 1], [2, 2], [3, 3]]);
  ...
  describe('rangeSearch edge cases', () => {
    it('should handle single point range', () => {
      const tree = new KDTree4([[1, 1], [2, 2]]);
