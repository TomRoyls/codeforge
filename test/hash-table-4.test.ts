...
describe('HashTable4', () => {
  describe('constructor', () => {
    it('creates table with default capacity 16', () => {
      const table = new HashTable4<number, number>();
    ...
    it('creates table with specified capacity', () => {
      const table = new HashTable4<number, number>(32);
      expect(table.capacity).toBe(32);
    });

    it('uses next power of two for capacity', () => {
      const table = new HashTable4<number, number>(10);
      expect(table.capacity).toBe(16);
    });

    it('handles capacity of 1', () => {
      const table = new HashTable4<number, number>(1);
  ...
  describe('set and get', () => {
    it('sets and gets values', () => {
      const table = new HashTable4<string, number>();
      table.set('a', 1);
    ...
    it('handles number keys', () => {
      const table = new HashTable4<number, string>();
      table.set(1, 'one');
      table.set(2, 'two');
    ...
    it('handles collision with quadratic probing', () => {
      const table = new HashTable4<number, number>(2);
      table.set(0, 100);
      table.set(2, 300);
      expect(table.get(0)).toBe(100);
      expect(table.get(2)).toBe(300);
    });

    it('handles string keys', () => {
      const table = new HashTable4<string, string>();
    ...
    it('handles collision after delete', () => {
      const table = new HashTable4<number, number>(4);
      table.set(0, 100);
      table.set(4, 500);
      table.delete(0);
      table.set(8, 900);
      expect(table.get(4)).toBe(500);
      expect(table.get(8)).toBe(900);
    });
  });
  ...
  describe('delete', () => {
    ...
    it('handles deleting key after collision', () => {
      ...
      table.set(0, 100);
      table.set(2, 300);
      expect(table.delete(0)).toBe(true);
  ...
  describe('clear', () => {
    ...
    it('preserves capacity after clear', () => {
      const table = new HashTable4<string, number>(32);
      table.set('a', 1);
      table.clear();
      expect(table.capacity).toBe(32);
    });
  ...
  describe('resize', () => {
    it('resizes to larger capacity', () => {
      const table = new HashTable4<string, number>(4);
      table.set('a', 1);
      table.set('b', 2);
      table.resize(16);
      expect(table.capacity).toBe(16);
    ...
    it('resizes to smaller capacity', () => {
      const table = new HashTable4<string, number>(16);
      table.set('a', 1);
      table.set('b', 2);
      table.resize(4);
  ...
  describe('getTimeComplexity', () => {
    it('returns time complexity string', () => {
      const table = new HashTable4<string, number>();
      expect(table.getTimeComplexity()).toBe('Average: O(1), Worst: O(n)');
    });
  });

  describe('auto-resize', () => {
    it('auto-resizes when load factor exceeds 0.7', () => {
      const table = new HashTable4<number, number>(8);
      for (let i = 0; i < 6; i++) {
        table.set(i, i);
      }
      expect(table.capacity).toBe(16);
    ...
    it('does not auto-resize below threshold', () => {
      const table = new HashTable4<number, number>(16);
      for (let i = 0; i < 5; i++) {
        table.set(i, i);
      }
      expect(table.capacity).toBe(16);
  ...
  describe('large number of entries', () => {
    ...
    it('handles many collisions with quadratic probing', () => {
      const table = new HashTable4<number, number>(4);
      for (let i = 0; i < 100; i++) {
        table.set(i * 4, i);
      }
  ...
  describe('overwrite existing key', () => {
    ...
    it('handles overwrite after collisions', () => {
      ...
      table.set(2, 300);
      table.set(0, 999);
      expect(table.get(0)).toBe(999);
      expect(table.get(2)).toBe(300);
      expect(table.size).toBe(2);
    });
  });

  describe('quadratic probing behavior', () => {
    it('uses quadratic probing sequence', () => {
      const table = new HashTable4<number, number>(4);
      table.set(0, 0);
      table.set(1, 1);
      table.set(2, 2);
    ...
    it('handles multiple collisions with quadratic probing', () => {
      const table = new HashTable4<number, number>(2);
      for (let i = 0; i < 5; i++) {
        table.set(i, i * 100);
      }
