...
describe('NTT', () => {
  ...
  it('multiplyPolynomials constant', () => {
    const result = NTT.multiplyPolynomials([5n], [3n])
    expect(result).toEqual([15n])
  })
  ...
  it('multiplyPolynomials by zero polynomial', () => {
    const result = NTT.multiplyPolynomials([1n, 2n], [0n])
    expect(result).toEqual([0n, 0n])
  })

  it('multiplyPolynomials by identity', () => {
    const result = NTT.multiplyPolynomials([1n, 1n], [1n])
    expect(result).toEqual([1n, 1n])
  })

  it('multiplyPolynomials constant by constant', () => {
