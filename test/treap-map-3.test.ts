...
describe('TreapMap3', () => {
  ...
  it('should return ordered keys', async () => {
    const map = new TreapMap3<number, string>();
    map.set(5, 'e');
    map.set(2, 'b');
    map.set(8, 'h');
  ...
  it('should return ordered values', async () => {
    const map = new TreapMap3<number, string>();
    map.set(3, 'c');
    map.set(1, 'a');
    map.set(2, 'b');
  ...
  it('should return ordered entries', async () => {
    const map = new TreapMap3<number, string>();
    map.set(2, 'b');
    map.set(1, 'a');
    map.set(3, 'c');
  ...
  it('should handle custom comparator', async () => {
    const map = new TreapMap3<string, number>((a, b) => {
  ...
  it('should stay balanced after many inserts', async () => {
