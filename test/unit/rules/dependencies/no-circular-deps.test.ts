...
function createMockContext(
  ...
  const reports: Array<{ message: string; loc?: { start: { line: number; column: number }; end: { line: number; column: number } } }> = [];
...
function createASTWithExports(exports: Array<{ source: string; type: 'named' | 'all'; line?: number }>): unknown {
  return {
