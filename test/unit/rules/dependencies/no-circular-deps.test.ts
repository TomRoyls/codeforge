...
describe('no-circular-deps rule', () => {
  ...
  describe('cycle detection', () => {
    ...
    test('should handle require with non-StringLiteral argument', () => {
      const context = createMockContext()
      const visitor = noCircularDepsRule.create(context)
    ...
    test('should handle require with StringLiteral without value', () => {
      const context = createMockContext()
      const visitor = noCircularDepsRule.create(context)
    ...
    test('should handle require with StringLiteral with non-string value', () => {
      const context = createMockContext()
      const visitor = noCircularDepsRule.create(context)
        ...
        declarations: [
          {
            init: {
              type: 'CallExpression',
              callee: { type: 'Identifier', name: 'require' },
              arguments: [{ type: 'StringLiteral', value: 123 }],
            },
          },
        ],
        loc: { start: { line: 1, column: 0 }, end: { line: 1, column: 30 } },
    ...
    test('should handle dynamic import with non-StringLiteral argument', () => {
      const context = createMockContext()
      const visitor = noCircularDepsRule.create(context)
