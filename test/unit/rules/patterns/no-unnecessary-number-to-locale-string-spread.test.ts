...
describe('no-unnecessary-number-to-locale-string-spread rule', () => {
  describe('meta', () => {
    ...
    test('should have docs url', () => {
      expect(noUnnecessaryNumberToLocaleStringSpreadRule.meta.docs.url).toBeDefined()
    })
    test('should have description', () => {
      expect(noUnnecessaryNumberToLocaleStringSpreadRule.meta.docs.description).toBeDefined()
    })
    test('should have valid docs description type', () => {
      expect(typeof noUnnecessaryNumberToLocaleStringSpreadRule.meta.docs.description).toBe('string')
    })
  })
  ...
  describe('edge cases', () => {
    test('should not report on empty arguments', () => {
      ...
      noUnnecessaryNumberToLocaleStringSpreadRule.create(context).CallExpression!(node)
