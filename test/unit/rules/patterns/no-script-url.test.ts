...
describe('no-script-url rule', () => {
  ...
  describe('positive cases — reports javascript: URL', () => {
    test('reports for "javascript:void(0)"', () => {
      ...
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:void(0)'))
    ...
    test('reports for "javascript:alert(1)"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:alert(1)'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "JavaScript:fetch(\'/api\')" camel case', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('JavaScript:fetch(\'/api\')'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "JAVASCRIPT:" bare prefix', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('JAVASCRIPT:'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript: window.close()" with space', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript: window.close()'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "JaVaScRiPt:foo" random case', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('JaVaScRiPt:foo'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:void(0);//comment"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:void(0);//comment'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:document.location=\'http://evil.com\'"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:document.location=\'http://evil.com\''))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:false"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:false'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:null"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:null'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:undefined"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:undefined'))
      expect(reports.length).toBe(1)
    })
    ...
    test('report loc values are preserved from node', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:void(0)', 5, 10, 5, 30))
    ...
    test('reports for "javascript:0"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:0'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:%20alert(1)"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:%20alert(1)'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:void(document.body.innerHTML=\'\')"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:void(document.body.innerHTML=\'\')'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:history.back()"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:history.back()'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:window.open(\'http://example.com\')"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:window.open(\'http://example.com\')'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:console.log(\'xss\')"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:console.log(\'xss\')'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:eval(\'code\')"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:eval(\'code\')'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:1+1"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:1+1'))
      expect(reports.length).toBe(1)
    })
    ...
    test('reports for "javascript:x" minimal code', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:x'))
      expect(reports.length).toBe(1)
    })
  ...
  describe('negative cases — does NOT report', () => {
    test('does not report for "http://example.com"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('http://example.com'))
    ...
    test('does not report for "https://example.com"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('https://example.com'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "ftp://files.example.com"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('ftp://files.example.com'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "mailto:user@example.com"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('mailto:user@example.com'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "tel:+1234567890"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('tel:+1234567890'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "data:text/html,<h1>Hello</h1>"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('data:text/html,<h1>Hello</h1>'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report when value is an object', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral({ type: 'StringLiteral', value: {}, loc: makeLoc(1, 0, 1, 5) })
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report when value is an array', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral({ type: 'StringLiteral', value: ['javascript:void(0)'], loc: makeLoc(1, 0, 1, 5) })
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "notjavascript:void(0)" no colon prefix', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('notjavascript:void(0)'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "/path/to/javascript:file" middle occurrence', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('/path/to/javascript:file'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "some text about javascript: something"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('some text about javascript: something'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "file:///path/to/file"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('file:///path/to/file'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "ws://localhost:8080"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('ws://localhost:8080'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "wss://secure.example.com"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('wss://secure.example.com'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "/relative/path"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('/relative/path'))
      expect(reports.length).toBe(0)
    })
    ...
    test('does not report for "#anchor"', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('#anchor'))
      expect(reports.length).toBe(0)
    })
  })
  ...
  describe('edge cases', () => {
    test('separate create() calls have independent state', () => {
      ...
      visitor1.StringLiteral(makeStringLiteralNode('javascript:void(0)'))
      visitor2.StringLiteral(makeStringLiteralNode('http://example.com'))
    ...
    test('handles node with empty loc object', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral({ type: 'StringLiteral', value: 'javascript:void(0)', loc: {} })
      expect(reports.length).toBe(1)
    })
    ...
    test('handles node with partial loc (missing end)', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral({ type: 'StringLiteral', value: 'javascript:void(0)', loc: { start: { line: 3, column: 5 } } })
      expect(reports.length).toBe(1)
    ...
    test('report loc reflects specific node location values', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral(makeStringLiteralNode('javascript:void(0)', 10, 4, 10, 24))
    ...
    test('handles node with _parent property', () => {
      const { context, reports } = createMockContext()
      const visitor = noScriptUrlRule.create(context)
      visitor.StringLiteral({ type: 'StringLiteral', value: 'javascript:void(0)', loc: makeLoc(1, 0, 1, 20), _parent: {} })
      expect(reports.length).toBe(1)
    })
