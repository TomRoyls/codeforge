...
describe('no-shadow rule', () => {
  ...
  describe('visitor isolation', () => {
    ...
    test('visitors with different contexts should work independently', () => {
      const { context: ctx1, reports: r1 } = createMockContext({}, '/src/a.ts')
      const { context: ctx2, reports: r2 } = createMockContext({}, '/src/b.ts')
    ...
    test('should not carry state between create calls', () => {
      ...
      const { reports: reports2 } = createMockContext()
  ...
  describe('context variations', () => {
    test('should work with different file paths', () => {
      const { context, reports } = createMockContext({}, '/some/deep/path/file.ts')
      const visitor = noShadowRule.create(context)
