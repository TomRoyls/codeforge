...
import { noUnnecessaryStringTrimEmpty } from '../../../../src/rules/patterns/no-unnecessary-string-trim-empty.js'
...
describe('no-unnecessary-string-trim-empty rule', () => {
  describe('meta', () => {
    test('should have correct type "suggestion"', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.type).toBe('suggestion')
    })

    test('should have severity "warn"', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.severity).toBe('warn')
    })

    test('should have correct category "patterns"', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.docs?.category).toBe('patterns')
    })

    test('should not be recommended', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.docs?.recommended).toBe(false)
    })

    test('should have a description', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.docs?.description).toBeTruthy()
    })

    test('should have description mentioning trim', () => {
      const desc = noUnnecessaryStringTrimEmpty.meta.docs?.description?.toLowerCase() ?? ''
      expect(desc).toMatch(/trim/)
    })

    test('should have correct docs URL', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.docs?.url).toBe(
        'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-string-trim-empty.ts',
      )
    })

    test('should have empty schema', () => {
      expect(noUnnecessaryStringTrimEmpty.meta.schema).toEqual([])
    })
  })
  ...
  describe('structure', () => {
    test('create() returns visitor with CallExpression', () => {
      ...
      const visitor = noUnnecessaryStringTrimEmpty.create(context)
      expect(visitor).toHaveProperty('CallExpression')
      expect(typeof visitor.CallExpression).toBe('function')
    })

    test('default export matches named export', () => {
      expect(noUnnecessaryStringTrimEmpty).toBeDefined()
      expect(noUnnecessaryStringTrimEmpty.meta).toBeDefined()
      expect(noUnnecessaryStringTrimEmpty.create).toBeDefined()
    })
  })
  ...
  describe('positive cases — reports unnecessary trim on empty string', () => {
    ...
    test('report message is exactly as defined in rule source', () => {
      ...
      expect(reports[0].message).toBe(
        'Trimming an empty string literal is unnecessary. The result is always an empty string.',
      )
    })
  ...
  describe('edge cases', () => {
    test('separate create() calls have independent state', () => {
      ...
      const visitor1 = noUnnecessaryStringTrimEmpty.create(ctx1)
      const visitor2 = noUnnecessaryStringTrimEmpty.create(ctx2)
    ...
    test('create returns a new visitor each call', () => {
      const { context } = createMockContext()
      const visitor1 = noUnnecessaryStringTrimEmpty.create(context)
      const visitor2 = noUnnecessaryStringTrimEmpty.create(context)
      expect(visitor1).not.toBe(visitor2)
    })

    test('meta is same reference across multiple accesses', () => {
      const meta1 = noUnnecessaryStringTrimEmpty.meta
      const meta2 = noUnnecessaryStringTrimEmpty.meta
      expect(meta1).toBe(meta2)
    })

    test('rule exports are correct', () => {
      expect(noUnnecessaryStringTrimEmpty).toBeDefined()
      expect(typeof noUnnecessaryStringTrimEmpty.create).toBe('function')
      expect(typeof noUnnecessaryStringTrimEmpty.meta).toBe('object')
    })
