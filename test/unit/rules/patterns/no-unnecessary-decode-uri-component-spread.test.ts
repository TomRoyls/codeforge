...
import { noUnnecessaryDecodeUriComponentSpreadRule } from '../../../../src/rules/patterns/no-unnecessary-decode-uri-component-spread.js';
import type { Linter } from '../../../../src/linter.js';
...
function makeDecodeUriComponentCall(
  args: unknown[],
  locStartLine: number,
  locStartCol: number,
  locEndLine: number,
...
function createContext(): {
  ...
  const ctx: RuleContext = {
    ...
    id: 'no-unnecessary-decode-uri-component-spread',
    options: {},
    source: '',
    filename: 'test.js',
  } as RuleContext;
...
describe('no-unnecessary-decode-uri-component-spread', () => {
  ...
  test('meta: rule type is suggestion', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.type).toBe('suggestion');
  });

  test('meta: severity is warn', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.severity).toBe('warn');
  });

  test('meta: category is patterns', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.category).toBe('patterns');
  });

  test('meta: recommended is false', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.recommended).toBe(false);
  });

  test('meta: description is truthy', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.description).toBeTruthy();
  });

  test('meta: description mentions decodeURIComponent', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.description).toContain(
      'decodeURIComponent',
    );
  });

  test('meta: docs URL is correct', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.docsUrl).toBe(
      'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-decode-uri-component-spread.ts',
    );
  });

  test('meta: schema is empty array', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule.schema).toEqual([]);
  });
  ...
  test('structure: create() returns visitor with CallExpression', () => {
    ...
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    expect(visitor).toHaveProperty('CallExpression');
    expect(typeof visitor.CallExpression).toBe('function');
  });

  test('structure: default export matches named export', () => {
    expect(noUnnecessaryDecodeUriComponentSpreadRule).toBeDefined();
    expect(noUnnecessaryDecodeUriComponentSpreadRule.create).toBeTypeOf('function');
  });
  ...
  test('positive: reports decodeURIComponent(...arr) with Identifier spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...[1, 2, 3]) with ArrayExpression spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...getItems()) with CallExpression spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...obj.items) with MemberExpression spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...{}) with ObjectExpression spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(..."abc") with Literal spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...null) with null literal spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: report message matches expected text', () => {
    ...
    expect(reports[0].message).toBe(
      'decodeURIComponent(...items) with spread is unusual. decodeURIComponent() expects a single string argument.',
    );
  });
  ...
  test('positive: reports decodeURIComponent(...a) with short identifier', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...longVariableName) with long identifier', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...(x)) with parenthesized expression spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('positive: reports decodeURIComponent(...arr) at different line numbers', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('arr'))],
  ...
  test('positive: reports decodeURIComponent(...arr) at column offset 0', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('arr'))],
  ...
  test('positive: reports decodeURIComponent(...arr) with large column offset', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('arr'))],
  ...
  test('positive: reports decodeURIComponent(...arr) with multi-line loc', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('arr'))],
  ...
  test('positive: reports decodeURIComponent(...fn()) with function call spread', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...obj.prop) with nested member expression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing TemplateLiteral', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing ConditionalExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing BinaryExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing ArrowFunctionExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing NewExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing AwaitExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing YieldExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing UnaryExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('positive: reports decodeURIComponent(...arr) with spread containing UpdateExpression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [
  ...
  test('negative: does NOT report for MemberExpression callee (obj.decodeURIComponent)', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = {
      type: 'CallExpression',
      callee: {
        ...
        property: makeIdentifier('decodeURIComponent'),
        computed: false,
      },
      arguments: [makeSpreadArg(makeIdentifier('items'))],
  ...
  test('negative: does NOT report for decodeURIComponent(str) with regular Identifier arg', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeIdentifier('str')],
  ...
  test('negative: does NOT report for decodeURIComponent("literal") with Literal arg', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeLiteral('%20hello')],
  ...
  test('negative: does NOT report for decodeURIComponent(...items, extra) with multiple args', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for decodeURIComponent() with no arguments', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall([], 1, 0, 1, 22);
    invokeVisitor(visitor, node);
    expect(reports).toHaveLength(0);
  });

  test('negative: does NOT report for decodeURIComponent with null arguments array', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = {
      type: 'CallExpression',
  ...
  test('negative: does NOT report for decodeURIComponent with undefined arguments', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = {
      type: 'CallExpression',
  ...
  test('negative: does NOT report for ReturnStatement node type', () => {
    ...
    const node = {
      ...
      argument: makeCallExpression(makeIdentifier('decodeURIComponent'), [
        makeSpreadArg(makeIdentifier('items')),
      ]),
    };
    invokeVisitor(visitor, node);
  ...
  test('negative: does NOT report for decodeURIComponent(str, ...items) with regular first arg', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for decodeURIComponent with empty string literal arg', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeLiteral('')],
  ...
  test('negative: does NOT report for decodeURIComponent with numeric literal arg', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
      [makeLiteral(42)],
  ...
  test('negative: does NOT report for decodeURIComponent with CallExpression arg (no spread)', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for decodeURIComponent with MemberExpression arg (no spread)', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for decodeURIComponent with ArrayExpression arg (no spread)', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for callee with null type', () => {
    ...
    const node = {
      type: 'CallExpression',
      callee: { type: null, name: 'decodeURIComponent' },
      arguments: [makeSpreadArg(makeIdentifier('items'))],
      loc: makeLoc(1, 0, 1, 30),
    };
    invokeVisitor(visitor, node);
  ...
  test('negative: does NOT report for callee with undefined type', () => {
    ...
    const node = {
      type: 'CallExpression',
      callee: { type: undefined, name: 'decodeURIComponent' },
      arguments: [makeSpreadArg(makeIdentifier('items'))],
      loc: makeLoc(1, 0, 1, 30),
    };
    invokeVisitor(visitor, node);
  ...
  test('negative: does NOT report for decodeURIComponent with TemplateLiteral arg (no spread)', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = makeDecodeUriComponentCall(
  ...
  test('negative: does NOT report for empty decodeURIComponent call expression', () => {
    const { reports, ctx } = createContext();
    const visitor = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx);
    const node = {
      type: 'CallExpression',
  ...
  test('edge: independent state between two rule instances', () => {
    ...
    const visitor1 = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx1.ctx);
    const visitor2 = noUnnecessaryDecodeUriComponentSpreadRule.create(ctx2.ctx);
    const node = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('items'))],
      1, 0, 1, 30,
    );
  ...
  test('edge: rule exports create function', () => {
    expect(typeof noUnnecessaryDecodeUriComponentSpreadRule.create).toBe('function');
  });
  ...
  test('edge: mixed valid and invalid calls report only invalid', () => {
    ...
    // Valid: no spread
    const validNode = makeDecodeUriComponentCall(
      [makeIdentifier('str')],
      1, 0, 1, 24,
    );
    ...
    // Invalid: with spread
    const invalidNode = makeDecodeUriComponentCall(
      [makeSpreadArg(makeIdentifier('items'))],
      2, 0, 2, 30,
    );
    ...
    // Valid again
    const validNode2 = makeDecodeUriComponentCall(
      [makeLiteral('url')],
      3, 0, 3, 26,
    );
  ...
  test('edge: rule object has all expected properties', () => {
    const rule = noUnnecessaryDecodeUriComponentSpreadRule;
