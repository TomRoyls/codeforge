...
describe('no-unnecessary-number-to-string-spread rule', () => {
  describe('meta', () => {
    ...
    test('should have docs url', () => {
      expect(noUnnecessaryNumberToStringSpreadRule.meta.docs.url).toBeDefined()
    })
    test('should have description', () => {
      expect(noUnnecessaryNumberToStringSpreadRule.meta.docs.description).toBeDefined()
    })
    test('should have valid docs description type', () => {
      expect(typeof noUnnecessaryNumberToStringSpreadRule.meta.docs.description).toBe('string')
    })
  })
  ...
  describe('edge cases', () => {
    test('should not report on empty arguments', () => {
      ...
      noUnnecessaryNumberToStringSpreadRule.create(context).CallExpression!(node)
