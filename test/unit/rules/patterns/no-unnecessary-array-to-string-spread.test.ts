...
describe('no-unnecessary-array-to-string-spread rule', () => {
  describe('meta', () => {
    ...
    test('should have docs url', () => {
      expect(noUnnecessaryArrayToStringSpreadRule.meta.docs.url).toBeDefined()
    })
    test('should have description', () => {
      expect(noUnnecessaryArrayToStringSpreadRule.meta.docs.description).toBeDefined()
    })
    test('should have valid docs description type', () => {
      expect(typeof noUnnecessaryArrayToStringSpreadRule.meta.docs.description).toBe('string')
    })
  })
  ...
  describe('edge cases', () => {
    test('should not report on empty arguments', () => {
      ...
      const node = makearrToStringCall([])
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(0)
    })
    test('should not report on two regular arguments', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([{ type: 'Literal', value: 1 }, { type: 'Literal', value: 2 }])
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(0)
    })
  })
  ...
  describe('should report arr.toString(...items) with single spread', () => {
    test('should report arr.toString(...items) case 1', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 1, 0, 1, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...arr) case 2', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'arr' })], 2, 0, 2, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...args) case 3', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'args' })], 3, 0, 3, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...list) case 4', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'list' })], 4, 0, 4, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...data) case 5', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'data' })], 5, 0, 5, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...values) case 6', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'values' })], 6, 0, 6, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...nums) case 7', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'nums' })], 7, 0, 7, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...rest) case 8', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'rest' })], 8, 0, 8, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...options) case 9', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'options' })], 9, 0, 9, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...params) case 10', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'params' })], 10, 0, 10, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...collection) case 11', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'collection' })], 11, 0, 11, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...elements) case 12', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'elements' })], 12, 0, 12, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...entries) case 13', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'entries' })], 13, 0, 13, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...objs) case 14', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'objs' })], 14, 0, 14, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...source) case 15', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'source' })], 15, 0, 15, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...input) case 16', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'input' })], 16, 0, 16, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...payload) case 17', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'payload' })], 17, 0, 17, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...buffer) case 18', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'buffer' })], 18, 0, 18, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...chunk) case 19', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'chunk' })], 19, 0, 19, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...segment) case 20', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'segment' })], 20, 0, 20, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...portion) case 21', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'portion' })], 21, 0, 21, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...range) case 22', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'range' })], 22, 0, 22, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...tuple) case 23', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'tuple' })], 23, 0, 23, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...seq) case 24', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'seq' })], 24, 0, 24, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...iter) case 25', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'iter' })], 25, 0, 25, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...result) case 26', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'result' })], 26, 0, 26, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...output) case 27', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'output' })], 27, 0, 27, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...response) case 28', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'response' })], 28, 0, 28, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...records) case 29', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'records' })], 29, 0, 29, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...rows) case 30', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'rows' })], 30, 0, 30, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...cols) case 31', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'cols' })], 31, 0, 31, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...cells) case 32', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'cells' })], 32, 0, 32, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...fields) case 33', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'fields' })], 33, 0, 33, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...props) case 34', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'props' })], 34, 0, 34, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...attrs) case 35', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'attrs' })], 35, 0, 35, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...keys) case 36', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'keys' })], 36, 0, 36, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...vals) case 37', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'vals' })], 37, 0, 37, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...pairs) case 38', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'pairs' })], 38, 0, 38, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...nodes) case 39', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'nodes' })], 39, 0, 39, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
    test('should report arr.toString(...items2) case 40', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items2' })], 40, 0, 40, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].message).toBeDefined()
    })
  ...
  describe('location and structure', () => {
    test('should report with correct location line 2', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 2, 5, 2, 30)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
    ...
    test('should report with correct location line 3', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 3, 10, 3, 35)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 5', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 5, 0, 5, 20)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 10', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 10, 8, 10, 28)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 15', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 15, 3, 15, 23)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 20', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 20, 0, 20, 15)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 25', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 25, 12, 25, 37)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 30', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 30, 1, 30, 21)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 40', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 40, 5, 40, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 50', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 50, 0, 50, 30)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 60', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 60, 7, 60, 27)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 70', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 70, 2, 70, 22)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 80', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 80, 0, 80, 20)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 90', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 90, 15, 90, 40)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 100', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 100, 0, 100, 25)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 150', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 150, 3, 150, 23)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
    ...
    test('should report with correct location line 200', () => {
      const { context, reports } = createMockContext()
      const node = makearrToStringCall([makeSpreadArg({ type: 'Identifier', name: 'items' })], 200, 8, 200, 33)
      noUnnecessaryArrayToStringSpreadRule.create(context).CallExpression!(node)
      expect(reports).toHaveLength(1)
      expect(reports[0].loc).toBeDefined()
