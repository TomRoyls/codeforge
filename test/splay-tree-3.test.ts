...
describe('SplayTree3 - Basic Operations', () => {
...
describe('SplayTree3 - Duplicate Handling', () => {
...
describe('SplayTree3 - Single Element', () => {
...
describe('SplayTree3 - Large Sequential Insert', () => {
...
describe('SplayTree3 - Large Random Insert', () => {
...
describe('SplayTree3 - Splay Behavior', () => {
...
describe('SplayTree3 - Edge Cases', () => {
...
describe('SplayTree3 - String Values', () => {
  it('should work with string values', () => {
    const tree = new SplayTree3<string>();
    tree.insert('apple');
    tree.insert('banana');
    tree.insert('cherry');
...
describe('SplayTree3 - Custom Comparator', () => {
  it('should use custom comparator', () => {
    const tree = new SplayTree3<number>((a, b) => {
      if (a > b) return -1;
      if (a < b) return 1;
      return 0;
    });
...
describe('SplayTree3 - Complex Operations', () => {
