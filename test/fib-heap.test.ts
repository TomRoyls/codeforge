...
describe('FibHeap', () => {
  ...
  describe('merge', () => {
    it('should merge two non-empty heaps', () => {
      const heap1 = new FibHeap<number>()
      const heap2 = new FibHeap<number>()
      heap1.insert(5)
      heap1.insert(10)
      heap2.insert(3)
      heap2.insert(7)
  ...
  describe('static merge', () => {
    it('should merge two heaps into new heap', () => {
      ...
      heap2.insert(3)
      heap2.insert(2)
      const merged = FibHeap.merge(heap1, heap2)
  ...
  describe('static fromArray', () => {
    it('should create heap from array', () => {
      const heap = FibHeap.fromArray([5, 3, 7, 1, 4])
    ...
    it('should extract in sorted order', () => {
      const heap = FibHeap.fromArray([5, 3, 7, 1, 4, 6, 2, 8])
      expect(heap.extractMin()).toBe(1)
    ...
    it('should accept custom comparator', () => {
      const heap = FibHeap.fromArray([5, 3, 7], { comparator: (a, b) => b - a })
  ...
  describe('edge cases', () => {
    ...
    it('should handle object values with comparator', () => {
      const heap = new FibHeap<{ id: number }>({
  ...
  describe('stress tests', () => {
    ...
    it('should handle bulk insert via fromArray', () => {
      ...
      const heap = FibHeap.fromArray(values)
      expect(heap.size).toBe(1000)
      for (let i = 0; i < 1000; i++) {
        expect(heap.extractMin()).toBe(i)
      }
