...
describe('LeftistHeap3', () => {
  describe('constructor', () => {
    ...
    it('should accept options with comparator', () => {
      const heap = new LeftistHeap3<number>({ comparator: (a, b) => b - a })
      heap.insert(5)
      heap.insert(3)
      heap.insert(7)
  ...
  describe('merge', () => {
    it('should merge two non-empty heaps', () => {
      const heap1 = new LeftistHeap3<number>()
      const heap2 = new LeftistHeap3<number>()
      heap1.insert(5)
      heap1.insert(10)
      heap2.insert(3)
      heap2.insert(7)
    ...
    it('should work with custom comparator', () => {
      const heap1 = new LeftistHeap3<number>({ comparator: (a, b) => b - a })
      const heap2 = new LeftistHeap3<number>({ comparator: (a, b) => b - a })
      heap1.insert(1)
      heap1.insert(3)
      heap2.insert(2)
      heap2.insert(4)
  ...
  describe('static merge', () => {
    it('should merge two heaps into new heap', () => {
      ...
      heap2.insert(3)
      heap2.insert(2)
      const merged = LeftistHeap3.merge(heap1, heap2)
  ...
  describe('update', () => {
    it('should decrease key when new value is smaller', () => {
      const heap = new LeftistHeap3<number>()
      heap.insert(5)
      heap.insert(3)
      const node = heap.insert(10)
    ...
    it('should reinsert when new value is larger', () => {
      const heap = new LeftistHeap3<number>()
  ...
  describe('delete', () => {
    ...
    it('should delete element and maintain heap property', () => {
      ...
      const node1 = heap.insert(5)
      heap.insert(3)
      const node2 = heap.insert(7)
      const node3 = heap.insert(1)
      heap.insert(9)
      heap.delete(node1)
      expect(heap.size).toBe(4)
      const result = []
    ...
    it('should handle delete on single element', () => {
      const heap = new LeftistHeap3<number>()
      const node = heap.insert(5)
      heap.delete(node)
      expect(heap.isEmpty).toBe(true)
  ...
  describe('static fromArray', () => {
    it('should create heap from array', () => {
      const heap = LeftistHeap3.fromArray([5, 3, 7, 1, 4])
      expect(heap.size).toBe(5)
      expect(heap.peek()).toBe(1)
    })

    it('should create empty heap from empty array', () => {
      const heap = LeftistHeap3.fromArray([])
      expect(heap.size).toBe(0)
      expect(heap.isEmpty).toBe(true)
    })

    it('should create heap from single element array', () => {
      const heap = LeftistHeap3.fromArray([42])
      expect(heap.size).toBe(1)
      expect(heap.peek()).toBe(42)
    })

    it('should extract in sorted order', () => {
      const heap = LeftistHeap3.fromArray([5, 3, 7, 1, 4, 6, 2, 8])
      expect(heap.extractMin()).toBe(1)
      expect(heap.extractMin()).toBe(2)
      expect(heap.extractMin()).toBe(3)
      expect(heap.extractMin()).toBe(4)
    ...
    it('should accept custom comparator', () => {
      const heap = LeftistHeap3.fromArray([5, 3, 7], { comparator: (a, b) => b - a })
      expect(heap.peek()).toBe(7)
    })
  })
  ...
  describe('edge cases', () => {
    ...
    it('should handle object values with comparator', () => {
      const heap = new LeftistHeap3<{ id: number }>({
  ...
  describe('stress tests', () => {
    ...
    it('should handle bulk insert via fromArray', () => {
      ...
      const heap = LeftistHeap3.fromArray(values)
      expect(heap.size).toBe(1000)
      for (let i = 0; i < 1000; i++) {
        expect(heap.extractMin()).toBe(i)
      }
    ...
    it('should maintain validity under stress', () => {
      const heap = new LeftistHeap3<number>()
      for (let i = 0; i < 500; i++) {
