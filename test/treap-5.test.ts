...
import { Treap } from './src/core/treap-5/index.js'
...
describe('Treap', () => {
  describe('Empty treap', () => {
    ...
    it('should return empty array for inOrderTraversal on empty treap', () => {
      const treap = new Treap<number>()
      expect(treap.inOrderTraversal()).toEqual([])
    })
  ...
  describe('Sequential inserts', () => {
    ...
    it('should return sorted array from inOrderTraversal', () => {
      const treap = new Treap<number>()
      treap.insert(5)
      treap.insert(3)
      treap.insert(7)
      treap.insert(1)
      expect(treap.inOrderTraversal()).toEqual([1, 3, 5, 7])
    })
  })
  ...
  describe('InOrderTraversal', () => {
    ...
    it('should return sorted array', () => {
      ...
      treap.insert(1)
      treap.insert(2)
      expect(treap.inOrderTraversal()).toEqual([1, 2, 3])
    })
    ...
    it('should work with many elements', () => {
      ...
      const values = [5, 3, 7, 1, 9, 2, 8, 4, 6]
      values.forEach(v => treap.insert(v))
      expect(treap.inOrderTraversal()).toEqual([1, 2, 3, 4, 5, 6, 7, 8, 9])
    })
  ...
  describe('Merge', () => {
    it('should merge empty with empty', () => {
      const treap1 = new Treap<number>()
      const treap2 = new Treap<number>()
      treap1.merge(treap2)
  ...
  describe('Custom comparator', () => {
    it('should work with custom comparator for strings', () => {
      const treap = new Treap<string>((a, b) => a.localeCompare(b))
      treap.insert('banana')
      treap.insert('apple')
      treap.insert('cherry')
    ...
    it('should work with reverse comparator', () => {
      const treap = new Treap<number>((a, b) => b - a)
      treap.insert(1)
      treap.insert(2)
      treap.insert(3)
