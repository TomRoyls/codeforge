...
} from './opal-dawn-helpers.js'
import {
  formatResultTable,
  formatResultJson,
} from './opal-dawn-format-helpers.js'

/** @example codeforge opal-dawn ./src */
export default class OpalDawn extends Command {
  ...
  /** @example OpalDawn.run() */
  public async run(): Promise<OpalHorizonResult> {
    const { args, flags } = await this.parse(OpalDawn)
