...
} from './velvet-gloom-helpers.js'
import {
  formatResultTable,
  formatResultJson,
} from './velvet-gloom-format-helpers.js'

/** @example codeforge velvet-gloom ./src */
export default class VelvetGloom extends Command {
  ...
  /** @example VelvetGloom.run() */
  public async run(): Promise<VelvetDarknessResult> {
    const { args, flags } = await this.parse(VelvetGloom)
