...
export class DynamicBitset {
  ...
  not(): DynamicBitset {
    const result = new DynamicBitset(this._size)
  ...
  equals(other: DynamicBitset): boolean {
...
export type { DynamicBitsetOptions } from './types.js'
