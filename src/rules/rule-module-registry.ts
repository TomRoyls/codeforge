...
'no-unnecessary-qualifier',
 ...
 'no-unnecessary-string-pad-end-spread',
  ...
  'no-unnecessary-string-split-spread',
    ...
    'no-unnecessary-math-expm1-spread',
    'no-unnecessary-math-log1p-spread',
    'no-unnecessary-math-sinh-spread',
    'no-unnecessary-math-cosh-spread',
    'no-unnecessary-math-tanh-spread',
        ...
        'no-unnecessary-date-set-full-year-spread',
        'no-unnecessary-date-set-month-spread',
        'no-unnecessary-date-set-date-spread',
        'no-unnecessary-date-set-hours-spread',
        'no-unnecessary-date-set-minutes-spread',
        'no-unnecessary-date-set-seconds-spread',
        'no-unnecessary-date-set-milliseconds-spread',
        'no-unnecessary-date-set-utc-full-year-spread',
        'no-unnecessary-date-set-utc-month-spread',
        'no-unnecessary-date-set-utc-date-spread',
        'no-unnecessary-date-set-utc-hours-spread',
        'no-unnecessary-date-set-utc-minutes-spread',
        'no-unnecessary-date-set-utc-seconds-spread',
        'no-unnecessary-date-set-utc-milliseconds-spread',
        'no-unnecessary-set-clear-spread',
        'no-unnecessary-set-keys-spread',
        'no-unnecessary-set-values-spread',
        'no-unnecessary-set-entries-spread',
        'no-unnecessary-map-keys-spread',
        'no-unnecessary-map-values-spread',
        'no-unnecessary-map-entries-spread',
        'no-unnecessary-error-to-string-spread',
        'no-unnecessary-regex-exec-spread',
        'no-unnecessary-regex-test-spread',
        'no-unnecessary-array-buffer-is-view-spread',
        'no-unnecessary-number-is-finite-spread',
        'no-unnecessary-number-is-nan-spread',
        'no-unnecessary-number-is-integer-spread',
        'no-unnecessary-number-is-safe-integer-spread',
        'no-unnecessary-number-parse-float-spread',
        'no-unnecessary-number-parse-int-spread',
        'no-unnecessary-string-from-char-code-spread',
        'no-unnecessary-string-from-code-point-spread',
        'no-unnecessary-string-raw-spread',
        'no-unnecessary-int8-array-from-spread',
        'no-unnecessary-int8-array-of-spread',
        'no-unnecessary-uint8-array-from-spread',
        'no-unnecessary-uint8-array-of-spread',
        'no-unnecessary-uint8-clamped-array-from-spread',
        'no-unnecessary-uint8-clamped-array-of-spread',
        'no-unnecessary-int16-array-from-spread',
...
'no-unnecessary-type-constraint',
       ...
       'no-unnecessary-values',
        ...
        'no-unnecessary-object-is-sealed-spread',
        'no-unnecessary-object-is-extensible-spread',
        'no-unnecessary-object-from-entries-spread',
        'no-unnecessary-object-group-by-spread',
        'no-unnecessary-array-buffer-slice-spread',
        'no-unnecessary-promise-try-spread',
        'no-unnecessary-string-char-at-spread',
        'no-unnecessary-string-char-code-at-spread',
        'no-unnecessary-string-code-point-at-spread',
        'no-unnecessary-string-concat-spread',
        ...
        'no-unnecessary-array-values-spread',
        'no-unnecessary-array-with-spread',
        'no-unnecessary-function-call-spread',
        'no-unnecessary-function-apply-spread',
        'no-unnecessary-function-bind-spread',
        'no-unnecessary-function-to-string-spread',
        'no-unnecessary-date-to-json-spread',
        'no-unnecessary-date-to-gmt-string-spread',
    'no-unnecessary-typed-array-at-spread',
    'no-unnecessary-typed-array-copy-within-spread',
    'no-unnecessary-typed-array-entries-spread',
    'no-unnecessary-typed-array-every-spread',
    'no-unnecessary-typed-array-fill-spread',
    'no-unnecessary-typed-array-filter-spread',
    'no-unnecessary-typed-array-find-spread',
    'no-unnecessary-typed-array-find-index-spread',
    'no-unnecessary-typed-array-find-last-spread',
    'no-unnecessary-typed-array-find-last-index-spread',
    'no-unnecessary-typed-array-for-each-spread',
    'no-unnecessary-typed-array-includes-spread',
    'no-unnecessary-typed-array-index-of-spread',
    'no-unnecessary-typed-array-join-spread',
    'no-unnecessary-typed-array-keys-spread',
    'no-unnecessary-typed-array-last-index-of-spread',
    'no-unnecessary-typed-array-map-spread',
    'no-unnecessary-typed-array-reduce-spread',
    'no-unnecessary-typed-array-reduce-right-spread',
    'no-unnecessary-typed-array-reverse-spread',
    'no-unnecessary-typed-array-set-spread',
    'no-unnecessary-typed-array-slice-spread',
    'no-unnecessary-typed-array-some-spread',
    'no-unnecessary-typed-array-sort-spread',
    'no-unnecessary-typed-array-sub-array-spread',
    'no-unnecessary-typed-array-to-locale-string-spread',
    'no-unnecessary-typed-array-to-string-spread',
    'no-unnecessary-typed-array-values-spread',
    'no-unnecessary-typed-array-with-spread',
    'no-unnecessary-dataview-get-big-int64-spread',
    'no-unnecessary-dataview-get-big-uint64-spread',
    'no-unnecessary-dataview-get-float32-spread',
    'no-unnecessary-dataview-get-float64-spread',
    'no-unnecessary-dataview-get-int16-spread',
    'no-unnecessary-dataview-get-int32-spread',
    'no-unnecessary-dataview-get-int8-spread',
    'no-unnecessary-dataview-get-uint16-spread',
    'no-unnecessary-dataview-get-uint32-spread',
    'no-unnecessary-dataview-get-uint8-spread',
    'no-unnecessary-dataview-set-big-int64-spread',
    'no-unnecessary-dataview-set-big-uint64-spread',
    'no-unnecessary-encode-uri-spread',
    'no-unnecessary-decode-uri-spread',
    'no-unnecessary-encode-uri-component-spread',
    'no-unnecessary-decode-uri-component-spread',
    'no-unnecessary-eval-spread',
    'no-unnecessary-is-finite-spread',
    'no-unnecessary-is-nan-spread',
    'no-unnecessary-parse-float-spread',
    'no-unnecessary-parse-int-spread',
    'no-unnecessary-shared-array-buffer-slice-spread',
    'no-unnecessary-int-8-array-set-spread',
    'no-unnecessary-int-8-array-subarray-spread',
    'no-unnecessary-int-8-array-slice-spread',
    'no-unnecessary-uint-8-array-set-spread',
    'no-unnecessary-uint-8-array-subarray-spread',
    'no-unnecessary-uint-8-array-slice-spread',
    'no-unnecessary-uint-8-clamped-array-set-spread',
    'no-unnecessary-uint-8-clamped-array-subarray-spread',
    'no-unnecessary-uint-8-clamped-array-slice-spread',
    'no-unnecessary-int-16-array-set-spread',
    'no-unnecessary-int-16-array-subarray-spread',
    'no-unnecessary-int-16-array-slice-spread',
    'no-unnecessary-uint-16-array-set-spread',
    'no-unnecessary-uint-16-array-subarray-spread',
    'no-unnecessary-uint-16-array-slice-spread',
    'no-unnecessary-int-32-array-set-spread',
    'no-unnecessary-int-32-array-subarray-spread',
    'no-unnecessary-int-32-array-slice-spread',
    'no-unnecessary-uint-32-array-set-spread',
    'no-unnecessary-uint-32-array-subarray-spread',
    'no-unnecessary-uint-32-array-slice-spread',
    'no-unnecessary-float-32-array-set-spread',
    'no-unnecessary-float-32-array-subarray-spread',
    'no-unnecessary-float-32-array-slice-spread',
    'no-unnecessary-float-64-array-set-spread',
    'no-unnecessary-float-64-array-subarray-spread',
    'no-unnecessary-float-64-array-slice-spread',
    'no-unnecessary-big-int-64-array-set-spread',
    'no-unnecessary-big-int-64-array-subarray-spread',
    'no-unnecessary-big-int-64-array-slice-spread',
    'no-unnecessary-big-uint-64-array-set-spread',
    'no-unnecessary-big-uint-64-array-subarray-spread',
    'no-unnecessary-big-uint-64-array-slice-spread',
    'no-unnecessary-int-8-array-fill-spread',
    'no-unnecessary-int-8-array-sort-spread',
    'no-unnecessary-int-8-array-reverse-spread',
    'no-unnecessary-int-8-array-copy-within-spread',
    'no-unnecessary-uint-8-array-fill-spread',
    'no-unnecessary-uint-8-array-sort-spread',
    'no-unnecessary-uint-8-array-reverse-spread',
    'no-unnecessary-uint-8-array-copy-within-spread',
    'no-unnecessary-uint-8-clamped-array-fill-spread',
    'no-unnecessary-uint-8-clamped-array-sort-spread',
    'no-unnecessary-uint-8-clamped-array-reverse-spread',
    'no-unnecessary-uint-8-clamped-array-copy-within-spread',
    'no-unnecessary-int-16-array-fill-spread',
    'no-unnecessary-int-16-array-sort-spread',
    'no-unnecessary-int-16-array-reverse-spread',
    'no-unnecessary-int-16-array-copy-within-spread',
    'no-unnecessary-uint-16-array-fill-spread',
    'no-unnecessary-uint-16-array-sort-spread',
    'no-unnecessary-uint-16-array-reverse-spread',
    'no-unnecessary-uint-16-array-copy-within-spread',
    'no-unnecessary-int-32-array-fill-spread',
    'no-unnecessary-int-32-array-sort-spread',
    'no-unnecessary-int-32-array-reverse-spread',
    'no-unnecessary-int-32-array-copy-within-spread',
    'no-unnecessary-uint-32-array-fill-spread',
    'no-unnecessary-uint-32-array-sort-spread',
    'no-unnecessary-uint-32-array-reverse-spread',
    'no-unnecessary-uint-32-array-copy-within-spread',
    'no-unnecessary-float-32-array-fill-spread',
    'no-unnecessary-float-32-array-sort-spread',
    'no-unnecessary-float-32-array-reverse-spread',
    'no-unnecessary-float-32-array-copy-within-spread',
    'no-unnecessary-float-64-array-fill-spread',
    'no-unnecessary-float-64-array-sort-spread',
    'no-unnecessary-float-64-array-reverse-spread',
    'no-unnecessary-float-64-array-copy-within-spread',
    'no-unnecessary-big-int-64-array-fill-spread',
    'no-unnecessary-big-int-64-array-sort-spread',
    'no-unnecessary-big-int-64-array-reverse-spread',
    'no-unnecessary-big-int-64-array-copy-within-spread',
    'no-unnecessary-big-uint-64-array-fill-spread',
    'no-unnecessary-big-uint-64-array-sort-spread',
    'no-unnecessary-big-uint-64-array-reverse-spread',
    'no-unnecessary-big-uint-64-array-copy-within-spread',
    'no-unnecessary-int-8-array-map-spread',
    'no-unnecessary-int-8-array-filter-spread',
    'no-unnecessary-int-8-array-find-spread',
    'no-unnecessary-int-8-array-every-spread',
    'no-unnecessary-int-8-array-some-spread',
    'no-unnecessary-int-8-array-for-each-spread',
    'no-unnecessary-uint-8-array-map-spread',
    'no-unnecessary-uint-8-array-filter-spread',
    'no-unnecessary-uint-8-array-find-spread',
    'no-unnecessary-uint-8-array-every-spread',
    'no-unnecessary-uint-8-array-some-spread',
    'no-unnecessary-uint-8-array-for-each-spread',
    'no-unnecessary-uint-8-clamped-array-map-spread',
    'no-unnecessary-uint-8-clamped-array-filter-spread',
    'no-unnecessary-uint-8-clamped-array-find-spread',
    'no-unnecessary-uint-8-clamped-array-every-spread',
    'no-unnecessary-uint-8-clamped-array-some-spread',
    'no-unnecessary-uint-8-clamped-array-for-each-spread',
    'no-unnecessary-int-16-array-map-spread',
    'no-unnecessary-int-16-array-filter-spread',
    'no-unnecessary-int-16-array-find-spread',
    'no-unnecessary-int-16-array-every-spread',
    'no-unnecessary-int-16-array-some-spread',
    'no-unnecessary-int-16-array-for-each-spread',
    'no-unnecessary-uint-16-array-map-spread',
    'no-unnecessary-uint-16-array-filter-spread',
    'no-unnecessary-uint-16-array-find-spread',
    'no-unnecessary-uint-16-array-every-spread',
    'no-unnecessary-uint-16-array-some-spread',
    'no-unnecessary-uint-16-array-for-each-spread',
    'no-unnecessary-int-32-array-map-spread',
    'no-unnecessary-int-32-array-filter-spread',
    'no-unnecessary-int-32-array-find-spread',
    'no-unnecessary-int-32-array-every-spread',
    'no-unnecessary-int-32-array-some-spread',
    'no-unnecessary-int-32-array-for-each-spread',
    'no-unnecessary-uint-32-array-map-spread',
    'no-unnecessary-uint-32-array-filter-spread',
    'no-unnecessary-uint-32-array-find-spread',
    'no-unnecessary-uint-32-array-every-spread',
    'no-unnecessary-uint-32-array-some-spread',
    'no-unnecessary-uint-32-array-for-each-spread',
    'no-unnecessary-float-32-array-map-spread',
    'no-unnecessary-float-32-array-filter-spread',
    'no-unnecessary-float-32-array-find-spread',
    'no-unnecessary-float-32-array-every-spread',
    'no-unnecessary-float-32-array-some-spread',
    'no-unnecessary-float-32-array-for-each-spread',
    'no-unnecessary-float-64-array-map-spread',
    'no-unnecessary-float-64-array-filter-spread',
    'no-unnecessary-float-64-array-find-spread',
    'no-unnecessary-float-64-array-every-spread',
    'no-unnecessary-float-64-array-some-spread',
    'no-unnecessary-float-64-array-for-each-spread',
    'no-unnecessary-big-int-64-array-map-spread',
    'no-unnecessary-big-int-64-array-filter-spread',
    'no-unnecessary-big-int-64-array-find-spread',
    'no-unnecessary-big-int-64-array-every-spread',
    'no-unnecessary-big-int-64-array-some-spread',
    'no-unnecessary-big-int-64-array-for-each-spread',
    'no-unnecessary-big-uint-64-array-map-spread',
    'no-unnecessary-big-uint-64-array-filter-spread',
    'no-unnecessary-big-uint-64-array-find-spread',
    'no-unnecessary-big-uint-64-array-every-spread',
    'no-unnecessary-big-uint-64-array-some-spread',
    'no-unnecessary-big-uint-64-array-for-each-spread',
    'no-unnecessary-dataview-set-float32-spread',
    'no-unnecessary-dataview-set-float64-spread',
    'no-unnecessary-dataview-set-int16-spread',
    'no-unnecessary-dataview-set-int32-spread',
    'no-unnecessary-dataview-set-int8-spread',
    'no-unnecessary-dataview-set-uint16-spread',
    'no-unnecessary-dataview-set-uint32-spread',
    'no-unnecessary-dataview-set-uint8-spread',
        'no-unnecessary-wait',
