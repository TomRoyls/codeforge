/**
 * Rule category definitions - lightweight module that can be imported
 * without triggering eager loading of all rule definitions.
 *
 * @module rules/categories
 */
...
// Missing pattern rules that were not in original RULE_CATEGORIES
// but are needed for correct category lookup
  ['no-array-destructuring']: 'patterns',
  ['no-assert-truthiness']: 'patterns',
