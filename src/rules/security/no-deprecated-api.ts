...
const DEPRECATED_APIS: Map<string, DeprecatedApiInfo> = new Map([
  ['escape', { name: 'escape', reason: 'Deprecated in ECMAScript v3', replacement: 'encodeURIComponent' }],
  ['unescape', { name: 'unescape', reason: 'Deprecated in ECMAScript v3', replacement: 'decodeURIComponent' }],
  ['substr', { name: 'substr', reason: 'Considered legacy', replacement: 'substring or slice' }],
  ['String.prototype.substr', { name: 'String.prototype.substr', reason: 'Considered legacy', replacement: 'String.prototype.substring or String.prototype.slice' }],
  ['Array.prototype.buffer', { name: 'Array.prototype.buffer', reason: 'Non-standard', replacement: 'TypedArrays' }],
  ...
  ['Date.prototype.getYear', { name: 'Date.prototype.getYear', reason: 'Deprecated', replacement: 'Date.prototype.getFullYear' }],
  ['Date.prototype.setYear', { name: 'Date.prototype.setYear', reason: 'Deprecated', replacement: 'Date.prototype.setFullYear' }],
  ['Date.prototype.toGMTString', { name: 'Date.prototype.toGMTString', reason: 'Deprecated', replacement: 'Date.prototype.toUTCString' }],
  ['compile', { name: 'compile', reason: 'Deprecated', since: 'ES2015' }],
  ['RegExp.prototype.compile', { name: 'RegExp.prototype.compile', reason: 'Deprecated', since: 'ES2015' }],
  ['__proto__', { name: '__proto__', reason: 'Deprecated', replacement: 'Object.getPrototypeOf / Object.setPrototypeOf' }],
  ['Object.prototype.__proto__', { name: 'Object.prototype.__proto__', reason: 'Deprecated', replacement: 'Object.getPrototypeOf / Object.setPrototypeOf' }],
  ['__defineGetter__', { name: '__defineGetter__', reason: 'Deprecated', replacement: 'Object.defineProperty' }],
  ['Object.prototype.__defineGetter__', { name: 'Object.prototype.__defineGetter__', reason: 'Deprecated', replacement: 'Object.defineProperty' }],
  ['__defineSetter__', { name: '__defineSetter__', reason: 'Deprecated', replacement: 'Object.defineProperty' }],
  ['Object.prototype.__defineSetter__', { name: 'Object.prototype.__defineSetter__', reason: 'Deprecated', replacement: 'Object.defineProperty' }],
  ['__lookupGetter__', { name: '__lookupGetter__', reason: 'Deprecated', replacement: 'Object.getOwnPropertyDescriptor' }],
  ['Object.prototype.__lookupGetter__', { name: 'Object.prototype.__lookupGetter__', reason: 'Deprecated', replacement: 'Object.getOwnPropertyDescriptor' }],
  ['__lookupSetter__', { name: '__lookupSetter__', reason: 'Deprecated', replacement: 'Object.getOwnPropertyDescriptor' }],
  ['Object.prototype.__lookupSetter__', { name: 'Object.prototype.__lookupSetter__', reason: 'Deprecated', replacement: 'Object.getOwnPropertyDescriptor' }],
  ['Buffer', { name: 'Buffer()', reason: 'Deprecated in favor of Buffer.alloc() and Buffer.from()', since: 'Node.js 6' }],
]);
...
function isDeprecatedCall(node: unknown, apis: Map<string, DeprecatedApiInfo>, ignoreList: Set<string>): DeprecatedApiInfo | null {
  if (!node || typeof node !== 'object') {
    return null;
  }
