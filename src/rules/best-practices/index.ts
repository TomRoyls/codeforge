export { noMagicNumbersRule, analyzeNoMagicNumbers } from './no-magic-numbers.js'
export {
...
export { preferArrayFindRule } from './prefer-array-find.js'
export { preferExponentOperatorRule } from './prefer-exponent-operator.js'
export { preferFlatMapRule } from './prefer-flat-map.js'
export { preferRegexLiteralRule } from './prefer-regex-literal.js'
