...
export const noUnnecessaryArrayFlatMapSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `arr.flatMap(...items) with spread is unusual. flatMap() expects a callback function.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about arr.flatMap(...items) with spread which is likely a mistake.',
      recommended: false,
