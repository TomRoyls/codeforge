...
export const noUnnecessaryArrayToSplicedSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: 'arr.toSpliced(...items) with a single spread is unusual. Consider calling arr.toSpliced() directly.',
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about arr.toSpliced(...items) with spread which is unusual since arr.toSpliced takes specific arguments, not a spread.',
      recommended: false,
