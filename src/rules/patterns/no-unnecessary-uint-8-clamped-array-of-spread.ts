...
export const noUnnecessaryUint8ClampedArrayOfSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Uint8ClampedArray.of(...items) with spread which is unusual since Uint8ClampedArray.of.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-uint-8-clamped-array-of-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
