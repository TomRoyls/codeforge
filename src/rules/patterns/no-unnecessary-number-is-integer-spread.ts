...
export const noUnnecessaryNumberIsIntegerSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `Number.isInteger(...items) with spread is unusual. isInteger() expects a single value.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Number.isInteger(...items) with spread which is likely a mistake.',
      recommended: false,
