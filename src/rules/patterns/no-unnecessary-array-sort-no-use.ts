...
export const noUnnecessaryArraySortNoUseRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description:
        'Flag .sort() used as a statement without using the return value.',
      recommended: false,
      url: 'https://github.com/codeforge-dev/codeforge/blob/main/docs/rules/patterns/no-unnecessary-array-sort-no-use.md',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryArraySortNoUseRule
