...
export const noUnnecessaryArraySpliceSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `arr.splice(...items) with spread is unusual. splice() expects start, deleteCount, and item arguments.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about arr.splice(...items) with spread which is likely a mistake.',
      recommended: false,
