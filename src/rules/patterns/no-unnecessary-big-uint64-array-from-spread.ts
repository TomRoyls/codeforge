...
export const noUnnecessaryBigUint64ArrayFromSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about BigUint64Array.from(...items) with spread which is unusual since BigUint64Array.from takes discrete arguments, not a spread.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-big-uint64-array-from-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
