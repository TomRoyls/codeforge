...
export const noUnnecessaryConsoleClearSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      ...
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-console-clear-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryConsoleClearSpreadRule
