...
export const noUnnecessaryStringToUpperCaseSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `str.toUpperCase(...items) with spread is unusual. toUpperCase() expects no arguments.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about str.toUpperCase(...items) with spread which is likely a mistake.',
      recommended: false,
