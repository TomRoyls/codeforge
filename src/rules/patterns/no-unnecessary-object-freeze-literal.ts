...
export const noUnnecessaryObjectFreezeLiteralRule: RuleDefinition = {
  create(context: RuleContext): RuleVisitor {
    return {
      CallExpression(node: unknown): void {
        ...
        if (propNode.type !== 'Identifier' || propNode.name !== 'freeze') return
  ...
  meta: {
    docs: {
      category: 'patterns',
      description:
        'Disallow Object.freeze() on empty object literals, which has no practical effect.',
      recommended: false,
      url: 'https://github.com/codeforge-dev/codeforge/blob/main/docs/rules/patterns/no-unnecessary-object-freeze-literal.md',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryObjectFreezeLiteralRule
