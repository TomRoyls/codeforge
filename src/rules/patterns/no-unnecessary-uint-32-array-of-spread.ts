...
export const noUnnecessaryUint32ArrayOfSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Uint32Array.of(...items) with spread which is unusual since Uint32Array.of.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-uint-32-array-of-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
