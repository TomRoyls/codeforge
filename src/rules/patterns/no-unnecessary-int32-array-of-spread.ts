...
export const noUnnecessaryInt32ArrayOfSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Int32Array.of(...items) with spread which is unusual since Int32Array.of takes discrete arguments, not a spread.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-int32-array-of-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
