...
export const noUnnecessaryConsoleTimeEndSpreadRule: RuleDefinition = {
  ...
  create(context: RuleContext): RuleVisitor {
    return {
      CallExpression(node: unknown): void {
        ...
        if (callee.property.name !== 'timeEnd') return
  ...
  meta: {
    ...
    docs: {
      ...
      description: 'Warn about console.timeEnd(...items) with spread which is likely a mistake.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-console-time-end-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryConsoleTimeEndSpreadRule
