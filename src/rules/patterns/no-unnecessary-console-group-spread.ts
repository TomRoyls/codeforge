...
export const noUnnecessaryConsoleGroupSpreadRule: RuleDefinition = {
  create(context: RuleContext): RuleVisitor {
    return {
      CallExpression(node: unknown): void {
        ...
        if (callee.property.name !== 'group') return
  ...
  meta: {
    docs: {
      ...
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-console-group-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryConsoleGroupSpreadRule
