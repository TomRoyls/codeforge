...
export const noUnnecessaryDateGetTimeSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about date.getTime(...items) with spread which is unusual since it takes no arguments.',
      recommended: false,
...
export default noUnnecessaryDateGetTimeSpreadRule
