...
export const noUnnecessaryStringAnchorSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `str.anchor(...items) with spread is unusual. anchor() expects a name string.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about str.anchor(...items) with spread which is likely a mistake.',
      recommended: false,
