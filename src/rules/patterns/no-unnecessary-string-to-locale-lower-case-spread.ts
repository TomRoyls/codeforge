...
export const noUnnecessaryStringToLocaleLowerCaseSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `str.toLocaleLowerCase(...items) with spread is unusual. toLocaleLowerCase() expects optional locale arguments.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about str.toLocaleLowerCase(...items) with spread which is likely a mistake.',
      recommended: false,
