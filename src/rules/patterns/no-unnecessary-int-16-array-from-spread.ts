...
export const noUnnecessaryInt16ArrayFromSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Int16Array.from(...items) with spread which is unusual since Int16Array.from.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-int-16-array-from-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
