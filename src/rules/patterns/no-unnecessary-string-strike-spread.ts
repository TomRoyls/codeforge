...
export const noUnnecessaryStringStrikeSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: 'str.strike(...items) with a single spread is unusual. Consider calling str.strike() directly.',
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about str.strike(...items) with spread which is unusual since str.strike takes specific arguments, not a spread.',
      recommended: false,
