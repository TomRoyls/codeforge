...
export const noUnnecessaryConsoleDirxmlSpreadRule: RuleDefinition = {
  ...
  create(context: RuleContext): RuleVisitor {
    return {
      CallExpression(node: unknown): void {
        ...
        if (callee.property.name !== 'dirxml') return
  ...
  meta: {
    ...
    docs: {
      ...
      description: 'Warn about console.dirxml(...items) with spread which is likely a mistake.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-console-dirxml-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
...
export default noUnnecessaryConsoleDirxmlSpreadRule
