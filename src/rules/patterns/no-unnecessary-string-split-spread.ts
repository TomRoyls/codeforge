...
export const noUnnecessaryStringSplitSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `str.split(...items) with spread is unusual. split() expects a separator and optional limit.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about str.split(...items) with spread which is likely a mistake.',
      recommended: false,
