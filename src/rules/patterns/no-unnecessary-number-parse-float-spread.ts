...
export const noUnnecessaryNumberParseFloatSpreadRule: RuleDefinition = {
  create(context: RuleContext): RuleVisitor {
    return {
      CallExpression(node: unknown): void {
        ...
        if (callee.property.name !== 'parseFloat') return
...
export default noUnnecessaryNumberParseFloatSpreadRule
