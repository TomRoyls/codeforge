...
export const noUnnecessaryObjectPreventExtensionsSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `Object.preventExtensions(...items) with spread is unusual. preventExtensions() expects a single object.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about Object.preventExtensions(...items) with spread which is likely a mistake.',
      recommended: false,
