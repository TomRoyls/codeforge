...
export const noUnnecessaryBigInt64ArrayOfSpreadRule: RuleDefinition = {
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about BigInt64Array.of(...items) with spread which is unusual since BigInt64Array.of.',
      recommended: false,
      url: 'https://github.com/nickelser/codeforge/blob/main/src/rules/patterns/no-unnecessary-big-int-64-array-of-spread.ts',
    },
    schema: [],
    severity: 'warn',
    type: 'suggestion',
