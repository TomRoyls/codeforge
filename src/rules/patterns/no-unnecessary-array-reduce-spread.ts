...
export const noUnnecessaryArrayReduceSpreadRule: RuleDefinition = {
    ...
    return {
      CallExpression(node: unknown): void {
        ...
        context.report({
          ...
          message: `arr.reduce(...items) with spread is unusual. reduce() expects a callback function.`,
          node: n,
        })
      },
    }
  ...
  meta: {
    docs: {
      category: 'patterns',
      description: 'Warn about arr.reduce(...items) with spread which is likely a mistake.',
      recommended: false,
