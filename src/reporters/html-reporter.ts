...
<body>
  <div class="container">
    ...
    <div class="summary">
      <div class="summary-card ${summary.errorCount > 0 ? 'has-errors' : ''}" onclick="filterBy('error')">
        <span class="summary-icon error">${SEVERITY_ICONS.error}</span>
        <span class="summary-count">${summary.errorCount}</span>
        <span class="summary-label">Errors</span>
      </div>
      <div class="summary-card ${summary.warningCount > 0 ? 'has-warnings' : ''}" onclick="filterBy('warning')">
        <span class="summary-icon warning">${SEVERITY_ICONS.warning}</span>
        <span class="summary-count">${summary.warningCount}</span>
        <span class="summary-label">Warnings</span>
      </div>
      <div class="summary-card" onclick="filterBy('info')">
        <span class="summary-icon info">${SEVERITY_ICONS.info}</span>
        <span class="summary-count">${summary.infoCount}</span>
        <span class="summary-label">Info</span>
      </div>
      <div class="summary-card" onclick="filterBy('all')">
        <span class="summary-icon files">📄</span>
        <span class="summary-count">${summary.totalFiles}</span>
    ...
    <details class="file-section" data-file="${this.escapeHtml(file.filePath)}" open>
      <summary class="file-header">
        ...
        <div class="file-badges">
          ...
          ${infoCount > 0 ? `<span class="badge info">${infoCount}</span>` : ''}
        </div>
      </summary>
